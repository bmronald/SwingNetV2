...
# Moved the model to the device
# The model is moved to the CUDA device (GPU) for accelerated computations if available, otherwise CPU is used.
# This is done to utilize the available hardware resources efficiently.
